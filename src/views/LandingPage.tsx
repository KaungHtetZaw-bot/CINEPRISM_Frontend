...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-app text-white selection:bg-amber-400 selection:text-black">
      ...
      <main className="relative z-20 -mt-[15vh] min-h-225 ">
        <div className="pt-24 px-4 md:px-12 pb-24 max-w-350 mx-auto relative overflow-hidden">
          ...
          <div className="relative z-40 flex flex-col mb-8 text-center md:text-left md:px-15 px-8">
            <div className="text-xl md:text-2xl font-black tracking-tight leading-none">
                <span className="text-muted group-hover:text-cinema-gold transition-colors">Trending</span>
