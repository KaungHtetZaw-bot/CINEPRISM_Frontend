const MovieSkeleton = () => {
  return (
    <div className="flex flex-col space-y-4 w-full group">
      <div className="relative aspect-2/3 w-full bg-white/5 rounded-sm overflow-hidden border border-white/5">
      ...
      <div className="px-1 space-y-2">
        <div className="h-3 bg-white/10 w-full rounded-xs opacity-50" />
